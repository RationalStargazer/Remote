...
import net.rationalstargazer.events.android.queue.RStaAndroidLooperHandler
import net.rationalstargazer.events.lifecycle.LifecycleDispatcher
import net.rationalstargazer.events.queue.RStaEventsQueueDispatcherFactory
 ...
 */
interface RStaValue<T> : RStaGenericValue<T, T>
...
fun demo() {
    ...
    fun injectStateValue(): RStaValue<State> {
        return ValueDispatcher(lifecycle, State()) {}
    }
